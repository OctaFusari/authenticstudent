...
@Component({
  selector: 'app-community-college',
  templateUrl: './community-college.component.html',
  styleUrls: ['./community-college.component.css']
})
export class CommunityCollegeComponent {
      ...
      if (window.innerWidth > 800) {
        if (window.scrollY >= (sezione__container__pos - 300)) {
          if ((window.scrollY >= (sezione__due.offsetTop - 300)) && (window.scrollY <= (sezione__tre.offsetTop - 300))) {
            ...
            sezione__due__title.innerHTML = "I nostri Community College";
            ...
            sezione__due__title.innerHTML = "I vantaggi di un Community College";
